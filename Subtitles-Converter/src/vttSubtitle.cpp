...
vttSubtitle::vttSubtitle(vectorr< SubtitleLine >& info) : Subtitle(info) {}

void vttSubtitle::ReadFromFile(std::string& file_name)
{
	...
	while (std::getline(in, temp))
	{
		...
		{
			throw std::runtime_error("Malformed VTT time line: " + temp);
		}
...
void vttSubtitle::WriteToFile(std::string& file_name)
{
